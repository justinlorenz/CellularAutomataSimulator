...
/**
 * LineGraph contains all methods that create the graph simulation. It contains methods that start
 * the graph in a different window than our board simulation and also methods that make
 * sure the data in the graph is updated every new generation of the Board Simulation
 *
 */
