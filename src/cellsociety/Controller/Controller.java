 ...
 * it's where our property files are uploaded and also where we have our update board
 *method that makes sure we are constantly updating the board and the graph at the same time and pace
 *
 */
