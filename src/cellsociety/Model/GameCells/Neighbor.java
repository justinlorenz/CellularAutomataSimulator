...
public abstract class Neighbor {
  ...
  /**
   * Gets the current type of edge type in the game and grabs the allowed indices for the current neighbor structure
   * @param edge
   */
  ...
  /**
   * Method where the current neighbor structure establishes which rowMove,colMove are allowed
   */
  public abstract void setNeighborIndices();

  /**
   * Method that check if the current rowMove,colMove reaches an allowed neighbor
   */
