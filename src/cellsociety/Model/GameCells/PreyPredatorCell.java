...
public class PreyPredatorCell extends Cell {
  ...
  /**
   * Implements the preypredator rules
   */
  @Override
  ...
  /*
   * Checks all neighbors of the cell to decide if should return and adds open moves to list
   */
  ...
  //moves to next state if allowed for prey,predator
  ...
  //Helper method that checks if neighbor is open for a move
