...
/**
 * Class that takes care of reading data from outside files. It's main responsibilities include reading
 * the data straight out of provided csv file for initial configuration of state,  placing that data
 * in a int[][], placing a board at random without a csv to base the layout on, placing board with a Checkered
 * pattern, get cell state number from desired location in board and get rows and columns numbers.
 * Can handle other starting configurations like Random and Checkered
 *
